...
public class StatusCommand extends VanillaCommand {
    ...
    public boolean execute(CommandSender sender, String commandLabel, String[] args) {
        ...
        if (simpleMode) {
            ...
            // 服务器信息
            {
                sender.sendMessage(TextFormat.YELLOW + ">>> " + TextFormat.RED + "Nukkit" + TextFormat.DARK_AQUA + "-" + TextFormat.LIGHT_PURPLE + "Features " + TextFormat.RESET + " Server Info" + TextFormat.YELLOW + " <<<" + TextFormat.RESET);
                // 运行时间
                long time = System.currentTimeMillis() - Nukkit.START_TIME;
                sender.sendMessage(TextFormat.GOLD + "Uptime: " + formatUptime(time));
                // TPS
