...
public class Nukkit {
    ...
    public static final String NUKKIT = "Nukkit Littlepick";
    public static final String BRANCH = "https://api.github.com/repos/explorer3039/Nukkit-Littlepick/commits/master";
    public final static Properties GIT_INFO = getGitInfo();
    public final static String VERSION = getVersion();
    public final static String API_VERSION = dynamic("CUSTOM");
    public final static String CODENAME = Utils.dynamic("Littlepick");
    ...
    public static void main(String[] args) {
        ...
        try {
            if (TITLE) {
                System.out.print("\u001B]0;Nukkit Littlepick\u0007");
            }
